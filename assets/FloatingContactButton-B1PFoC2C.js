import{r as i,j as t}from"./index-BLpLhe0U.js";import{M as a}from"./mail-D77t5bql.js";import"./createLucideIcon-DQenfvBO.js";const p=({onClick:r})=>{const[e,o]=i.useState(null),n=()=>{try{r()}catch(s){o("Error al intentar abrir el modal de contacto."),console.error("Error en FloatingContactButton:",s)}};return e?t.jsx("div",{className:"fixed inset-0 flex justify-center items-center bg-red-500 text-white z-[1100]",children:t.jsx("p",{children:e})}):t.jsx("div",{className:`fixed z-[1000] flex items-center justify-center bottom-[75px] right-[10px] sm:bottom-[90px] md:bottom-[100px] md:right-[20px]
