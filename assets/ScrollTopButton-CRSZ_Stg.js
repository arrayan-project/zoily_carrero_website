import{r as i,j as a}from"./index-BLpLhe0U.js";function l(o,r){let n,e,t;return function(...s){n?(clearTimeout(e),e=setTimeout(()=>{Date.now()-t>=r&&(o.apply(this,s),t=Date.now())},r-(Date.now()-t))):(o.apply(this,s),t=Date.now(),n=!0)}}const c=()=>{const[o,r]=i.useState(!1);i.useEffect(()=>{const e=l(()=>{const t=window.pageYOffset;r(t>300)},250);return window.addEventListener("scroll",e),()=>{window.removeEventListener("scroll",e)}},[]);const n=()=>{window.scrollTo({top:0,behavior:"smooth"})};return o?a.jsx("button",{type:"button",onClick:n,className:`
