import{r,b as v,j as e}from"./index-BLpLhe0U.js";import{C as x}from"./ContactUsForm-CYozMzYk.js";import{g as p}from"./utils-DQPssQXU.js";import{X as h}from"./x-BqdeCdVk.js";import"./createLucideIcon-DQenfvBO.js";const $=({isOpen:t,onClose:d})=>{const a=r.useRef(null),m=r.useRef(null),{theme:n}=v(),[s,f]=r.useState(!1),[i,l]=r.useState(!1);r.useEffect(()=>{t&&(f(!0),l(!1))},[t]);const c=()=>{i||!t||(l(!0),setTimeout(()=>{d(),l(!1)},300))};if(r.useEffect(()=>{const u=g=>{a.current&&!a.current.contains(g.target)&&c()};return t&&s&&document.addEventListener("mousedown",u),()=>{document.removeEventListener("mousedown",u)}},[t,s,c]),!t&&!i)return null;const o=t&&s&&!i;return e.jsx("div",{ref:m,className:`
            ...
            `,role:"dialog","aria-modal":"true",children:e.jsxs("div",{ref:a,className:`
                ...
                `,children:[e.jsx("button",{className:`
                        ...
                        ${o?"pointer-events-auto":"pointer-events-none"} /* Control de interacción */
                    `,onClick:c,"aria-label":"Cerrar modal",children:e.jsx(h,{className:"h-6 w-6"})}),e.jsx("div",{className:`mb-8 ${o?"pointer-events-auto":"pointer-events-none"}`,children:e.jsx("h2",{className:`text-2xl font-cinzel tracking-wide ${p(n)} mb-6`,children:"Contáctame"})}),e.jsx("div",{className:`${o?"pointer-events-auto":"pointer-events-none"}`,children:e.jsx(x,{})})]})})};export{$ as default};
