  ...
  return (
    <div style={{ backgroundColor: colors.background }}> 
      <div className="max-w-3xl mx-auto p-6 text-base">
        <h1 className="text-2xl font-cinzel mb-16 mt-24 text-center" style={{ color: colors.accent }}>Política de Privacidad</h1>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>1. Información que recopilamos</h2>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>2. Uso de la información</h2>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>3. Uso de herramientas y servicios de terceros</h2>
        <p className="mb-2 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>4. Compartición de la información</h2>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>5. Seguridad de la información</h2>
        <p className="mb-2 font-cinzel" style={{ color: colors.text }}>Implementamos medidas de seguridad adecuadas para proteger tu información personal contra accesos no autorizados, alteración, divulgación o destrucción. Sin embargo, ninguna transmisión por Internet es completamente segura, por lo que no podemos garantizar la seguridad absoluta de la información.</p>

        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>6. Tus derechos</h2>
        <p className="mb-2 font-cinzel" style={{ color: colors.text }}>De acuerdo con la Ley N° 19.628 sobre Protección de la Vida Privada en Chile, tienes derecho a:</p>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <p className="mb-2 font-cinzel" style={{ color: colors.text }} >Para ejercer estos derechos, puedes contactarnos a través de [correo electrónico de contacto].</p>

        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>7. Cookies</h2>
        <p className="mb-2 font-cinzel" style={{ color: colors.text }}>Nuestro sitio web utiliza cookies para mejorar la experiencia del usuario. Las cookies son pequeños archivos de texto que se almacenan en tu dispositivo y nos permiten recordar tus preferencias. Puedes configurar tu navegador para rechazar las cookies o para que te avise cuando se envíen. Sin embargo, algunas funciones de nuestro sitio pueden no funcionar correctamente sin cookies.</p>

        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>8. Cambios en esta política</h2>
        <p className="mb-2 font-cinzel" style={{ color: colors.text }}>Nos reservamos el derecho de modificar esta Política de Privacidad en cualquier momento. Cualquier cambio será publicado en esta página con una fecha de actualización. Te recomendamos revisar periódicamente esta política para estar informado sobre cómo protegemos tu información.</p>

        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>9. Contacto</h2>
        <p className="mb-2 font-cinzel" style={{ color: colors.text }}>Si tienes preguntas o inquietudes sobre esta Política de Privacidad o sobre cómo manejamos tu información personal, puedes contactarnos a:</p>
        <p className="mb-2 font-cinzel" style={{ color: colors.text }}>Correo electrónico: [correo electrónico de contacto]</p>
      </div>
