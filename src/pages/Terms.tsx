  ...
  return (
    <div style={{ backgroundColor: colors.background }}>
      <div className="max-w-3xl mx-auto p-6 text-base">
        <h1 className="text-2xl font-cinzel mb-8 mt-24 text-center" style={{ color: colors.accent }}>Términos y Condiciones del Servicio</h1>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>1. Reservas y Pagos</h2>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>2. Condiciones del Servicio</h2>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>3. Pruebas y Atención en Estudio</h2>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>4. Servicio a Domicilio</h2>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>5. Recomendaciones</h2>
        <ul className="list-disc list-inside mb-4 font-cinzel" style={{ color: colors.text }}>
        ...
        <h2 className="text-xl font-cinzel mt-6 mb-2" style={{ color: colors.accent }}>6. Contacto</h2>
