...
const AboutParagraphContent: React.FC = React.memo(() => {
  ...
  return (
    ...
    <section>
      <div className="lg:grid lg:grid-cols-2 lg:gap-8 prose prose-lg mx-auto" style={{ color: colors.text }}>
        {description1 && (
        ...
        {description2 && (
          <RevealWrapper animationClass="fade-in-text">
            <p className={`${PARAGRAPH_CLASS} mt-4 lg:mt-0 leading-relaxed text-center lg:text-left`}>
              {description2}
            </p>
          </RevealWrapper>
        )}
