...
interface ExpressMakeupServiceItem {
...
interface ExpressModalProps {
  ...
  expressMakeupServices: {
    ...
    category: string;
    items: ExpressMakeupServiceItem[]; // 'items' ahora es un array de NoviaMakeupServiceItem
  };
}

const ModalServices: React.FC<ExpressModalProps> = ({
  isOpen,
  onClose,
  theme,
  expressImages,
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      {expressMakeupServices.items.map(
                        (item: ExpressMakeupServiceItem, itemIndex: number) => (
                          <div
                            key={itemIndex}
