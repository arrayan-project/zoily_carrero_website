...
interface GlamMakeupServiceItem {
...
interface GlamModalProps {
  ...
  glamMakeupServices: {
    ...
    category: string;
    items: GlamMakeupServiceItem[]; // 'items' ahora es un array de NoviaMakeupServiceItem
  };
}

const ModalServices: React.FC<GlamModalProps> = ({
  isOpen,
  onClose,
  theme,
  glamImages,
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      {glamMakeupServices.items.map(
                        (item: GlamMakeupServiceItem, itemIndex: number) => (
                          <div
                            key={itemIndex}
