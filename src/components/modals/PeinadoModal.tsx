...
interface PeinadoMakeupServiceItem {
...
interface PeinadoModalProps {
  ...
  peinadoMakeupServices: {
    ...
    category: string;
    items: PeinadoMakeupServiceItem[]; // 'items' ahora es un array de NoviaMakeupServiceItem
  };
}

const ModalServices: React.FC<PeinadoModalProps> = ({
  isOpen,
  onClose,
  theme,
  peinadoImages,
          ...
          >
            ...
            >
              ...
              <button
                ...
                onClick={() => setActiveTabModalPeinado("InformacionModalPeinado")}
              >
                Informacion
              </button>
              <button
                ...
                onClick={() => setActiveTabModalPeinado("TerminosModalPeinado")}
              >
                Términos
              </button>
              <button
                ...
                onClick={() => setActiveTabModalPeinado("ImagenesModalPeinado")}
              >
                Imagenes
              </button>
            </div>
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      {peinadoMakeupServices.items.map(
                        (item: PeinadoMakeupServiceItem, itemIndex: number) => (
                          <div
                            key={itemIndex}
