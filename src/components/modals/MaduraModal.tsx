...
interface MaduraMakeupServiceItem {
...
interface MaduraModalProps {
  ...
  maduraMakeupServices: {
    ...
    category: string;
    items: MaduraMakeupServiceItem[]; // 'items' ahora es un array de NoviaMakeupServiceItem
  };
}

const ModalServices: React.FC<MaduraModalProps> = ({
  isOpen,
  onClose,
  theme,
  maduraImages,
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      {maduraMakeupServices.items.map(
                        (item: MaduraMakeupServiceItem, itemIndex: number) => (
                          <div
                            key={itemIndex}
