...
const HomeGallerySection: React.FC<HomeGallerySectionProps> = ({
  ...
  if (!galleryItem) {
    return null; // O un componente de carga/fallback
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-stretch gap-8">
          ...
          <div className="relative z-0 flex flex-col py-8 pl-8 pr-4 md:pl-20 md:pr-10">
            ...
            <div className="flex-grow">
              ...
              <RevealWrapper animationClass="slide-in-left-animation">
                <h2
                  className={`${FONT_FAMILY_PRIMARY} text-3xl lg:text-4xl xl:text-5xl`}
                  style={{ color: colors.secondaryText }}
                >
                  {galleryItem.title}
                </h2>
                <h2
                  className={`${FONT_FAMILY_PRIMARY} text-3xl lg:text-4xl xl:text-5xl mb-12`}
                  style={{ color: colors.text }}
                >
                  {galleryItem.title1}
                </h2>
            ...
            <div className="mt-auto pt-8">
              <RevealWrapper animationClass="fade-in-up-animation">
                ...
                >
                  {galleryItem.title} {galleryItem.title1}
                </h3>
              </RevealWrapper>
            </div>
          </div>
          ...
          {/* Se define una altura fija en móvil (h-96) y se deja que 'items-stretch' controle la altura en tablet/desktop (md:h-auto) */}
          <div className="relative z-10 overflow-hidden h-96 md:h-auto">
            {/* Se añade h-full para que el wrapper ocupe toda la altura de su padre */}
            <RevealWrapper animationClass="slide-in-right-animation" className="h-full">
              <SmoothImage
