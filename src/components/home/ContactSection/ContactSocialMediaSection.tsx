...
const ContactSocialMediaSection: React.FC = () => {
  ...
  return (
    <div
      className="rounded-lg shadow-sm p-2 md:p-8"
    ...
    >
      ...
      <div className="flex space-x-4">
        {[
          ...
          link ? (
            <RevealWrapper key={platform} animationClass="fade-in-text">
              <a
                href={link}
                target="_blank"
                rel="noopener noreferrer"
                className="font-cinzel hover:text-pink-600 transition-colors"
