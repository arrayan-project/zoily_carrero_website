  ...
  return (
    <div className="ugc-phone-container-png relative max-w-md mx-auto">
      ...
      <SmoothImage
        src={contentImage}
        alt={alt}
        className="ugc-image-example-png absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 w-[92%] h-[99%] rounded-[20px] md:w-[94%] md:h-[99%] md:rounded-[50px] object-cover aspect-[0.7]"
        loading="lazy"
      />
    </div>
  );
